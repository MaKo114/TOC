...
function Content({ searchTerm }) {
  const [isTeamLoading, setIsTeamLoading] = useState(true); // โหลดรายชื่อทีม
  const [isPlayerLoading, setIsPlayerLoading] = useState(false); // โหลดข้อมูลผู้เล่น/สตาฟ
